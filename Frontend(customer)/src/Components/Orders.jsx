                ...
                <div className="p-6">
                  ...
                  <div className='space-y-4'>
                    {item?.Order  && (
                      ...
                      <p className="text-gray-600 font-semibold">{item.Order.shippingStreet},</p>
                      <p className="text-gray-600 font-semibold">
                        {item.Order.shippingCity},{" "} {item.Order.shippingDistrict},
                         {" "}{item.Order.shippingState}
                      </p>
                      <p className="text-gray-600 font-semibold">{item.Order.shippingPincode}</p>
                    </div>
                    <div>
                  ...
                  <div className="mt-6 flex flex-wrap gap-4">
                    <Link to={item.productId ? `/products/${item.productId}`:"/products"
